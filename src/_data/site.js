    ...
    projects: [
      {
        ...
        details: [
          ...
          "<strong>CI/CD and infrastructure</strong><br>Built a git-push-to-deploy workflow across three platforms: frontend deployment on <strong>Vercel</strong>, FastAPI backend deployment to <strong>Fly.io</strong> through <strong>GitHub Actions</strong>, and Supabase migrations through GitHub integration. Transactional auth email is handled through <strong>Resend SMTP</strong> wired into Supabase Auth with custom-domain <strong>SPF</strong>, <strong>DKIM</strong>, and <strong>DMARC</strong>.",
        ],
      },
      {
        name: "Unsaid",
